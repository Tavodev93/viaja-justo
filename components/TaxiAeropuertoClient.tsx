...
export default function TaxiAeropuertoClient() {
    ...
    <main className="min-h-screen bg-gray-50 py-16 px-6">
      <div className="max-w-3xl mx-auto bg-white p-10 rounded-xl shadow-sm">
        ...
        <h1 className="text-3xl font-bold mb-4 text-center">
          Precio justo del taxi del aeropuerto de Cartagena
        </h1>

        {/* PASO 2 · FRASE UNIFICADA */}
        <p className="text-gray-600 mb-8 text-center">
          Estos son los rangos de precios que usan turistas y locales. Pagar de
          más es opcional.
        </p>

        {/* PASO 3 · BLOQUE DE PRECIO */}
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6 text-center">
          <p className="text-lg">
            <strong>Rango justo:</strong>{" "}
            {hasAccess ? "$20.000 – $30.000 COP" : "Contenido bloqueado"}
          </p>
        </div>
